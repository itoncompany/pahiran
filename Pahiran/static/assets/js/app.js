...
(function($) {
  ...
  PAHIRAN.initialize = {
    ...
    init: function() {
      PAHIRAN.initialize.general();
      PAHIRAN.initialize.mobileMenu();
    },
  ...
  PAHIRAN.documentOnReady = {
    init: function() {
      PAHIRAN.initialize.init();

    },
  };

  PAHIRAN.documentOnLoad = {
    init: function() {
  ...
  PAHIRAN.documentOnResize = {
    init: function() {

    },
  };

  PAHIRAN.documentOnScroll = {
    init: function() {
  ...
  $(document).ready(PAHIRAN.documentOnReady.init);
  $(window).on('load', PAHIRAN.documentOnLoad.init);
  $(window).on('resize', PAHIRAN.documentOnResize.init);
  $(window).on('scroll', PAHIRAN.documentOnScroll.init);
